...
'''
def rl_evaluate_policy_multiple_times(env,policy,maximum_episode_length=100000,discount_factor=1.0,nb_episodes=1):
    r=0

    for i in range(nb_episodes):
        r=r+rl_evaluate_policy(env,policy,maximum_episode_length=maximum_episode_length,discount_factor=discount_factor,render=False)
